 ...
 * @author molin
 */
public class PresentarFacturaNegocio extends javax.swing.JFrame {
    ...
    public PresentarFacturaNegocio(String cliente, Object []row) {
        initComponents();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        //direccionBase+="\\\\Bdd.s3db";
        //ReportesFacturaNegocio reportesN=new ReportesFacturaNegocio(direccionBase);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PresentarFacturaNegocio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PresentarFacturaNegocio().setVisible(true);
            }
        });
    }
